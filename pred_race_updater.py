...
class PredictRaceUpdater:
    ...
    def wideOdds(self, horse1, horse2):
        p = horse1.predict.pp_icchaku * horse2.predict.pp_nichaku + horse1.predict.pp_icchaku * horse2.predict.pp_sanchaku
        p += horse1.predict.pp_nichaku * horse2.predict.pp_icchaku + horse1.predict.pp_nichaku * horse2.predict.pp_sanchaku
        p += horse1.predict.pp_sanchaku * horse2.predict.pp_icchaku + horse1.predict.pp_sanchaku * horse2.predict.pp_icchaku
        return 1/p
